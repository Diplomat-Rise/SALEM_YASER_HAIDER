...
BEGIN:VCARD
VERSION:3.0
FN:SALEM YASER HAIDER 
TITLE:Sales Manager
ORG:RISE Properties
TEL;TYPE=WORK,VOICE:+971557840292
TEL;TYPE=WORK,VOICE:+971542919064
TEL;TYPE=WORK,VOICE:+97145665109
EMAIL:Salem.Haider@riseproperties.ae
URL:http://www.riseproperties.ae
ADR;TYPE=WORK:;;PO Box No 455979, Office NO.1607, Opal Tower, Business Bay;Dubai;;UAE
END:VCARD
  `.trim();
  ...
  const a = document.createElement('a');
  a.href = url;
  a.download = 'SALEM_YASER_HAIDER.vcf';
  document.body.appendChild(a);
  a.click();
  document.body.removeChild(a);
  URL.revokeObjectURL(url);
